...
public class PutController {
    ...
    public String putMemberDto1(@RequestBody MemberDto member) {
     ...
     * */
    @PutMapping(value = "/member2")
    public MemberDto putMemberDto2(@RequestBody MemberDto member) {
     ...
     * */
    @PutMapping(value = "/member2")
    public ResponseEntity<MemberDto> putMemberDto3(@RequestBody MemberDto member) {
